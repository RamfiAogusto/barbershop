            ...
            >
              <Card className="bg-gray-900 border-gray-800 hover:border-amber-500/50 transition-all duration-300 h-full overflow-hidden">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-400">
                    Experimenta la excelencia en el arte del corte de pelo y con técnicas tradicionales. Desde estilos clásicos hasta tendencias modernas, cada corte es una obra de arte que resalta tu personalidad y estilo único.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
